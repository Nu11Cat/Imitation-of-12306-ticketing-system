package cn.nu11cat.train.${module}.service;
...
import cn.nu11cat.train.${module}.domain.${Domain};
import cn.nu11cat.train.${module}.domain.${Domain}Example;
import cn.nu11cat.train.${module}.mapper.${Domain}Mapper;
