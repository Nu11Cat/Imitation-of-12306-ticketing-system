...
export default defineComponent({
  ...
  setup() {
    ...
    const onDelete = (record) => {
      axios.delete("/train-business/admin/station/delete/" + record.id).then((response) => {
    ...
    const handleOk = () => {
      axios.post("/train-business/admin/station/save", station.value).then((response) => {
    ...
    const handleQuery = (param) => {
      ...
      loading.value = true;
      axios.get("/train-business/admin/station/query-list", {
        params: {
          page: param.page,
          size: param.size
        }
